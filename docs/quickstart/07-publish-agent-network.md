...
![Explorer context menu showing Agent Network and Publish Agent Network Assets](images/65-publish-agent-network-menu.png)
...
![Publish Agent Network Assets to Exchange view with version group and project metadata ready to publish](images/66-publish-agent-network-assets-dialog.png)
...
![Agent Fabric CLI output and notification confirming the Agent Network assets were published to Anypoint Exchange](images/67-agent-network-publish-complete.png)
...
![Anypoint Exchange All assets view with the publishing business group selected as a filter](images/68-exchange-business-group-filter.png)
...
![Anypoint Exchange showing all seven published IT Help Investigation Agent Network assets](images/69-seven-published-agent-network-assets.png)
...
![IT Help Investigation Agent Network asset in Exchange showing its broker registry, agents, MCP servers, LLM, and stable version](images/70-agent-network-exchange-registry.png)
...
![Agent Visualizer rendering the IT Help Investigation Broker and its connected agents and MCP servers](images/71-agent-network-visualizer.png)
